...
fun getOfflineTtsConfig(
    ...
    if (modelName.isEmpty() && acousticModelName.isEmpty()) throw IllegalArgumentException("Please specify a TTS model")
    if (modelName.isNotEmpty() && acousticModelName.isNotEmpty()) throw IllegalArgumentException("Please specify either a VITS or a Matcha model, but not both")
    if (acousticModelName.isNotEmpty() && vocoder.isEmpty()) throw IllegalArgumentException("Please provide vocoder for Matcha TTS")

    val vModel = OfflineTtsVitsModelConfig(
